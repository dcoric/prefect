...
### `ArmadaImagePullPolicy` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L241" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>


Enum representing the image pull policy options for an Armada job.


### `ArmadaWorkerJobConfiguration` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L249" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `container` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L412" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `get_credentials` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L432" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `get_environment_variable_value` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L416" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `prepare_for_flow_run` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L480" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `ArmadaWorkerVariables` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L714" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `ArmadaWorkerResult` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L890" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>


Contains information about the final state of a completed process


### `ArmadaWorker` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L894" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `kill_infrastructure` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L973" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `run` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-armada/prefect_armada/worker.py#L933" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
